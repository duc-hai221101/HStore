...
<head>
    ...
    <link href="{{ asset('Eshopper/css/font-awesome.min.min.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('Eshopper/js/respond.js') }}"></script>
...
<body>
	...
	<script src="{{ asset('Eshopper/js/scrollUp.min.js') }}"></script>
